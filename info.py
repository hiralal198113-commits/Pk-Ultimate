...
API_ID = int(environ.get('API_ID', '30239641'))
API_HASH = environ.get('API_HASH', 'f81acbe7ba69b9d04bbec9b4a07811aa')
BOT_TOKEN = environ.get('BOT_TOKEN', "8413029258:AAHAT_Vb4MHYIxW_J1QxNNnJYD-kU978Rss")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5755059875').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002668772213'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002951625050').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003689257359')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002951625050')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Praveen211:Praveen211@praveen211.9xzsnbr.mongodb.net/?appName=Praveen211")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Praveen211")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Praveen211')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/discusssiongroup99')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tmkocdirect')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'supprotgrup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Praveen_sirvii')
